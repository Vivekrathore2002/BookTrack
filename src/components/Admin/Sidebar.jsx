...
const Sidebar = () => {
    ...
    return <VStack spacing={'8'} p="16  " boxShadow={'-2px 0 10px rgba(46, 255, 25, 0.8)'}>
        ...
        <LinkButton url="Courses" title="Books" Icon={RiEyeFill} active={location.pathname === "/admin/Courses"} />
        <LinkButton url="createcourse" title="Add Books" Icon={RiAddCircleFill} active={location.pathname === "/admin/createcourse"} />
